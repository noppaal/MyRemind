...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    header("Location: ../../public/index.php?msg=invalid_request");
    exit;
}
...
// Validasi nama grup
if (empty($namaGrup)) {
    header("Location: ../../public/index.php?msg=grup_name_required");
    exit;
}

if (strlen($namaGrup) > 100) {
    header("Location: ../../public/index.php?msg=grup_name_too_long");
    exit;
}
...
try {
    ...
    header("Location: ../../public/index.php?tab=grup&msg=grup_create_failed");
}
?>
